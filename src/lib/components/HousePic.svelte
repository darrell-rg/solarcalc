...
<svg viewBox="-50 -50 100 100" {style}>
	...
	{#each Array(10) as _, i}
		<path class="bubbles" d="M {i}, {(i % 2) / 2} v 18 " transform="translate(-26 17) scale(0.9)" />
	{/each}
	<path
	...
	{#if showShowerPerson}
	<g id="showerUser" transform="translate(14 0) scale(0.125)">
		<ellipse
	...
	<g id="showerDoor" transform="translate(6 10) scale(1.25,1.34)">
		<path
			opacity=".75"
