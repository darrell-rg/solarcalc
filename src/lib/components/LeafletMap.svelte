<script lang="ts">
	...
	function updateMapPos(event: any) {
		// console.log(event);
	}
...
<div class="leafletMap">
	<Leaflet view={initialView} zoom={14}>
       ...
       c0-8.001-6.484-14.487-14.492-14.487c-6.205,0-11.461,3.925-13.518,9.409h15.954V24.858z"
							/>
							<path
								d="M106.368,29.61l-7.953-2.137c-0.1-0.029-0.213-0.007-0.295,0.06c-0.085,0.063-0.13,0.161-0.13,0.269v4.276
       c0,0.104,0.045,0.207,0.13,0.27c0.082,0.067,0.195,0.084,0.295,0.055l7.953-2.137C106.655,30.185,106.655,29.69,106.368,29.61z"
							/>
							<path
								d="M76.981,11.77h4.281c0.106,0,0.205-0.049,0.268-0.133c0.062-0.083,0.085-0.19,0.062-0.291l-2.143-7.952
       c-0.075-0.294-0.571-0.294-0.65,0l-2.139,7.952c-0.03,0.101-0.007,0.21,0.059,0.291C76.78,11.721,76.882,11.77,76.981,11.77z"
							/>
							<path
								d="M93.48,18.603c0.075,0.074,0.178,0.11,0.284,0.096c0.099-0.01,0.194-0.073,0.249-0.166l4.106-7.134
       ...
       L93.48,18.603z"
							/>
							<path
								d="M92.371,41.343c-0.051-0.087-0.144-0.15-0.243-0.164c-0.105-0.016-0.208,0.021-0.283,0.094l-2.775,2.775l0.249,1.033
       l6.701,3.858c0.264,0.15,0.616-0.2,0.465-0.462L92.371,41.343z"
							/>
							<path
								d="M62.848,18.708c0.096,0.007,0.201-0.032,0.273-0.106l3.025-3.023c0.071-0.074,0.113-0.176,0.099-0.277
