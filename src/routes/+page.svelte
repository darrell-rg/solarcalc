	...
	<span>
		<Box>
			...
			<label>
				...
				<br />
				{#each Array(12) as _, i}
					<input type="checkbox" bind:checked={$pv.peakHours[i + 12]} title={indexToTime(i + 12)} />
				{/each}
			</label>
			<hr />
...
<div class="smol-sidebar">
	...
	<span>
		<Box style="padding-top:0px; padding-bottom:0px;">
			...
			<p>
				<b>Desired Output Temp</b> 40°C is good enough for showers, but for washing dishes it helps to
				have it at 50°C. The thermostatic mixing valve and the top element (city power) thermostat should
				be set to this temperature.
			</p>
			<p>
