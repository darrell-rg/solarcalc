...
def runSim(lat= 40.57, lon=-105.07, year=2010):
    ...
    filename_sim = "tmp/" + "sim_" +hash + ".csv"
...
df, filename = runSim(lat= 40.57, lon=-105.07, year=2010)
nsrdb_plot(df, 180, filename)
